...
describe('solverUtils', () => {
    describe('getDist', () => {
        it('calculates Euclidean distance correctly', () => {
            const nodeA: DBNode = { id: 1, name: 'A', x: 0, y: 0, type: 'waypoint', graph_id: 1, a: 0, level: 1 };
            const nodeB: DBNode = { id: 2, name: 'B', x: 3, y: 4, type: 'waypoint', graph_id: 1, a: 0, level: 1 };
    ...
    describe('generateDistanceMatrix', () => {
        it('generates a matrix with correct distances', () => {
            const nodes: DBNode[] = [
                { id: 1, name: 'A', x: 0, y: 0, type: 'waypoint', graph_id: 1, a: 0, level: 1 },
                { id: 2, name: 'B', x: 10, y: 0, type: 'waypoint', graph_id: 1, a: 0, level: 1 },
                { id: 3, name: 'C', x: 10, y: 10, type: 'waypoint', graph_id: 1, a: 0, level: 1 }
            ];
            const edges: DBEdge[] = [
    ...
    describe('formatTasksForSolver', () => {
        it('maps task names to node indices', () => {
            const nodes: DBNode[] = [
                { id: 1, name: 'Depot', x: 0, y: 0, type: 'depot', graph_id: 1, a: 0, level: 1 },
                { id: 2, name: 'Pickup', x: 10, y: 0, type: 'waypoint', graph_id: 1, a: 0, level: 1 },
                { id: 3, name: 'Dropoff', x: 20, y: 0, type: 'waypoint', graph_id: 1, a: 0, level: 1 }
            ];
