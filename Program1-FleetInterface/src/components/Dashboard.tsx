...
const StatCard: React.FC<{
  ...
  return (
    <div className="bg-[#1e1e20] p-6 rounded-2xl border border-white/5 hover:border-white/10 transition-all group relative overflow-hidden">
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch Requests Stats (count only)
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white font-sans flex overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        {/* TOPBAR */}
        <div className="h-16 bg-[#121214]/50 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-8 sticky top-0 z-20">
          ...
          <div className="flex items-center gap-6">
            <div className="relative group">
              ...
              <input
                ...
                className="bg-[#1e1e20] border border-white/5 focus:border-blue-500/50 rounded-full py-2 pl-10 pr-4 text-xs outline-none transition-all w-64 text-gray-300 placeholder:text-gray-600 focus:w-80"
              />
            </div>
            <button className="relative text-gray-400 hover:text-white transition-colors">
              <Bell size={20} />
              <span className="absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full border border-[#121214]"></span>
            </button>
            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-cyan-400 border border-white/20 ring-2 ring-white/5"></div>
          </div>
        </div>
          ...
          <div className="max-w-[1600px] mx-auto space-y-8">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex justify-between items-end">
                <div>
                  <h2 className="text-xl font-bold text-white mb-1">Recent Designs</h2>
